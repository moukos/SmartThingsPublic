definition(
    name: "Simultaneous event triggers App 2 (problematic)",
    namespace: "smart-auto-lock-unlock",
    author: "themis",
    description: "Problematic open/close operations",
...
def lockDoor()
{
	if (lock1.latestValue("lock") == "unlocked")
    	{
    	log.debug "Other app locking $lock1..."
    	lock1.lock()
        log.debug "Other app unlocking $lock1..."
    	lock1.unlock()
